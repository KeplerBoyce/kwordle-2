...
export default function LetterBox(props: {
  ...
  return (
    <div className={"border-3 w-16 h-16 flex justify-center items-center text-3xl font-semibold uppercase "
      + (color === "gray" ? "bg-wordle-gray border-wordle-gray text-white" :
        ...
        ("bg-transparent text-slate-500 " + (active ? "border-slate-300" : "border-slate-200")))))
    }>
      {char}
    </div>
  );
